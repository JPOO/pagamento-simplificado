                ...
                <div class="d-flex ml-5">
                    ...
                    @guest
                        ...
                        <ul class="navbar-nav ml-lg-0">
                            <li class="nav-item">
                                <a class="nav-link text-primary" href="new-user">
                                    Novo usuário
                                </a>
                            </li>
                            <li class="nav-item">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; IXC Software 2025</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<script src="{{asset('admin/vendor/jquery/jquery.mask.js')}}"></script>
